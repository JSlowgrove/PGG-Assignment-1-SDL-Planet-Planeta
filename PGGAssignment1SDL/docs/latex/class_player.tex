...
\hline
{\em float} & the sprite sheet x number. \\
\hline
{\em float} & the sprite sheet y number. \\
\hline
\end{DoxyParams}
...
the number of lives the \hyperlink{class_player}{Player} has. 
\end{DoxyReturn}
...
the score the \hyperlink{class_player}{Player} has. 
\end{DoxyReturn}
