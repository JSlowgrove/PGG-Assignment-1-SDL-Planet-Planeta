...
\hypertarget{class_block_a196ba551e96906126d843bb69399a980}{\index{Block@{Block}!set\+Velocity@{set\+Velocity}}
\index{set\+Velocity@{set\+Velocity}!Block@{Block}}
\subsubsection[{set\+Velocity}]{\setlength{\rightskip}{0pt plus 5cm}void Block\+::set\+Velocity (
\begin{DoxyParamCaption}
\item[{float}]{input\+Velocity}
\end{DoxyParamCaption}
)}}\label{class_block_a196ba551e96906126d843bb69399a980}
Setter \# velocity Sets the velocity of the \hyperlink{class_block}{Block} to the inputed velocity. 
\begin{DoxyParams}{Parameters}
...
\hline
\end{DoxyParams}
\hypertarget{class_block_a439237c91643b204336f75e5cd3721ca}{\index{Block@{Block}!update\+X@{update\+X}}
\index{update\+X@{update\+X}!Block@{Block}}
\subsubsection[{update\+X}]{\setlength{\rightskip}{0pt plus 5cm}void Block\+::update\+X (
\begin{DoxyParamCaption}
\item[{float}]{dt}
\end{DoxyParamCaption}
)}}\label{class_block_a439237c91643b204336f75e5cd3721ca}
Updates the x position of the \hyperlink{class_block}{Block} Updates the x position using the velocity and the inputed delta\+Time. 
\begin{DoxyParams}{Parameters}
